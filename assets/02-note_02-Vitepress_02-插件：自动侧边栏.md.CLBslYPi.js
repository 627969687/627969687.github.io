import{_ as n,c as a,a0 as e,o as p}from"./chunks/framework.2vPioZfv.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"02-note/02-Vitepress/02-插件：自动侧边栏.md","filePath":"02-note/02-Vitepress/02-插件：自动侧边栏.md","lastUpdated":1736176804000}'),l={name:"02-note/02-Vitepress/02-插件：自动侧边栏.md"};function i(r,s,t,c,b,o){return p(),a("div",null,s[0]||(s[0]=[e(`<p><a href="https://vitepress-sidebar.cdget.com/guide/getting-started" target="_blank" rel="noreferrer">官方文档</a></p><ol><li>安装方法比较简单，阅读官方文档即可，个人倾向于用<code>yarn</code>的方式</li><li>官方推荐使用<code>withSidebar</code>，个人喜欢<code>generateSidebar</code></li><li>案例演示的是多级侧边栏跟导航栏联动</li><li><a href="https://vitepress-sidebar.cdget.com/advanced-usage/multi-level-sidebar-with-indents" target="_blank" rel="noreferrer">解决缩进问题</a></li></ol><p>案例：</p><div class="language-node.js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">node.js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { defineConfig } from &#39;vitepress&#39;</span></span>
